                            ...
                            Align(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Align(
                                    alignment:
                                        AlignmentDirectional(-0.72, -0.25),
                                    child: Text(
                                      'Senha',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                  ...
                                  Align(
                                    alignment:
                                        AlignmentDirectional(-0.65, 0.25),
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed('EsqueciSenhaPage');
                                      },
                                      child: Text(
                                        'Esqueceu a senha?',
                                        style: FlutterFlowTheme.of(context)
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Align(
                                        alignment:
                                            AlignmentDirectional(-0.49, 0.82),
                                        child: Text(
                                      ...
                                      Align(
                                        alignment:
                                            AlignmentDirectional(0.62, 0.82),
                                        child: InkWell(
                                          splashColor: Colors.transparent,
                                          focusColor: Colors.transparent,
                                          hoverColor: Colors.transparent,
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            context.pushNamed('CadastroPage');
                                          },
                                          child: Text(
                                            'Criar conta',
                                            style: FlutterFlowTheme.of(context)
